...
import { MapPin, Phone, Mail, Send, CheckCircle2, X, MessageCircle, ArrowRight } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-3">
                  <div className="bg-gradient-to-br from-gray-900 to-black p-2 rounded-xl shadow-[0_0_15px_rgba(0,229,255,0.2)] border border-white/10">
                        <img src="https://advedasolutions.in/sc.png" alt="Shriya's Coaching" className="h-10 w-auto object-contain" />
                  </div>
                  <div className="flex flex-col">
                      <span className="font-bold text-white">Shriya's Coaching</span>
                      <span className="text-xs text-slate-500">Building Foundations</span>
                  </div>
              </div>
              <p className="text-slate-500 text-sm">&copy; 2023 Shriya's Coaching. All rights reserved.</p>
          </div>
      </footer>
